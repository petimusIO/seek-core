...
class LearningPlanService:
    ...
    def __init__(self, api_key: Optional[str] = None, model: Optional[str] = None, config: Optional[Dict[str, Any]] = None):
        """
        ...
        self.explanation_service = ExplanationService(self.llm_service, config=self.config)
    ...
    def generate_learning_plan(self, learner: LearnerProfile) -> LearningPlanResponse:
        ...
        try:
            ...
            personalized_explanation = self.explanation_service.generate_explanation(learner)
