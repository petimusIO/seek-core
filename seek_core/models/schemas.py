...
class LearnerProfile(BaseModel):
    ...
    known_topics: List[str] = Field(default_factory=list, description="Topics the learner already understands")
    struggles: List[str] = Field(default_factory=list, description="Topics the learner finds challenging")
...
class LearningPlanResponse(BaseModel):
    ...
    personalized_explanation: str = Field(..., description="Personalized explanation of the goal topic")
    resource_link: Optional[str] = Field(None, description="Optional link to additional resources")
